...
import AppNavigationContent from '@/components/navigation/AppNavigationContent.vue'
  ...
  <Sheet v-model:open="isOpen">
    <SheetTrigger as-child>
      <Button
        ...
        tone="neutral"
        size="icon-touch"
        class="shrink-0 border-[#d9ddd5] bg-white text-[#303630] shadow-[0_6px_24px_rgba(24,35,26,0.06)] hover:bg-[#f1f3ee] md:hidden"
        aria-label="내비게이션 열기"
      >
        <Menu class="size-5" />
      </Button>
    ...
    <SheetContent
      ...
      class="gap-0 border-l border-white/[0.07] bg-[#111512] p-0 text-white duration-500 data-[side=right]:w-72 data-[side=right]:max-w-[85vw] data-[side=right]:sm:max-w-none md:hidden"
    >
      <SheetTitle class="sr-only">애플리케이션 내비게이션</SheetTitle>
      <SheetDescription class="sr-only">
        사용 가능한 메뉴를 선택하여 페이지를 이동합니다.
      </SheetDescription>
